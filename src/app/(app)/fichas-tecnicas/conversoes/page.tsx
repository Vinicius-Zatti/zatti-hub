    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-sm text-cinza-medio">
          Pra quando o produto é comprado numa unidade e usado em outra na receita - ex: óleo de soja
          entra 1 UND de 900ml no Estoque, mas a ficha técnica usa em ML. Sem conversão cadastrada, a
          ficha usa a mesma unidade do Estoque direto.
        </p>
      </div>
