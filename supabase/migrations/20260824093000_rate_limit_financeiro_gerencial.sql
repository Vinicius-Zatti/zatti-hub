-- Novas chaves de rate limit do módulo Financeiro gerencial. Recria a função
-- inteira com a lista acumulada (mesmo padrão de toda migração anterior que
-- mexeu em `consumir_limite_requisicao`) - substituir sem repetir as chaves
-- já existentes as desativaria silenciosamente.
