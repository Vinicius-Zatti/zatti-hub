-- Novas chaves de rate limit da Contagem por setor. Recria a funcao inteira com a
-- lista acumulada (mesmo padrao de toda migracao anterior que mexeu em
-- `consumir_limite_requisicao`) - substituir sem repetir as chaves ja
-- existentes as desativaria silenciosamente.
