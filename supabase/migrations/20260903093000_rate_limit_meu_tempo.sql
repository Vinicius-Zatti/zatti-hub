-- Novas chaves de rate limit do módulo Meu Tempo. Recria a função inteira
-- com a lista acumulada (mesmo padrão de toda migração anterior que mexeu em
-- `consumir_limite_requisicao`) - substituir sem repetir as chaves já
